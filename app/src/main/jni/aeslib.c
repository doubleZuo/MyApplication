...
#include <com_example_user_myapplication_AESJni.h>
...
/*
 */
jbyteArray  Java_com_example_user_myapplication_AESJni_getKeyValue(JNIEnv *env, jobject obj)
{
 ...
 */
jbyteArray  Java_com_example_user_myapplication_AESJni_getIv
